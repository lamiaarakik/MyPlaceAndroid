...
public class BlankFragment extends Fragment {
    ...
    public ArrayList<Health.HealthItem> mylist=new ArrayList<Health.HealthItem>();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String pharmacieUrl = "https://maps.googleapis.com/maps/api/place/nearbysearch/json?location="+latitude+","+longitude+"&radius=5000&types=health&key=AIzaSyDtrJnZMxWGlXHg34U-Q9ggz1bFKZWnTsc";
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    for (int i = 0; i < res.length(); i++) {
                        Health.HealthItem pharmacie = new Health.HealthItem();
                ...
                if (view instanceof RecyclerView) {
                    ...
                    MyHealthRecyclerViewAdapter.RecyclerViewClickListener mylistener = new MyHealthRecyclerViewAdapter.RecyclerViewClickListener() {
                        @Override
                    ...
                    MyHealthRecyclerViewAdapter adapter = new MyHealthRecyclerViewAdapter(mylist, mylistener, getActivity());
    ...
    public interface OnListFragmentInteractionListener {
        ...
        void onListFragmentInteraction(Health.HealthItem item);
    }
}
