...
public class Restaurant {
    ...
    private static void addItem(RestaurantItem pharmacie) {
        ITEMS.add(pharmacie);
    ...
    public static class RestaurantItem{
        ...
        public RestaurantItem(String id, String name, double lat, double lng, String icon, String vicinity, double rating, double distance) {
            this.id = id;
            this.name = name;
            this.lat = lat;
            this.lng = lng;
        ...
        public RestaurantItem(String id, String name, String vicinity,double distance,double lat, double lng) {
            this.id = id;
            this.name = name;
            this.vicinity = vicinity;
            this.distance=distance;
